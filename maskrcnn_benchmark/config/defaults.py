...
_C.MODEL.DYHEAD.OV.DYNAMIC_CLIP_CLASSIFIER_WEIGHT_CACHE_PTH = "../DATASET/VG150_relation_aware_embedding.pt"
...
_C.MODEL.DYHEAD.OV.ZS_PREDICATES = [2, 4, 5, 14, 15, 18, 24, 26, 28, 32, 34, 36, 39, 44, 45] # for 51 predicates
